Feature: Play the game
  ...
  Scenario: Select rock against paper
    ...
    And I press "play" within "submit"
    Then I should see "And the winner is.." within "result"
    And I should see "You lose.. paper beats rock" within "result"
  ...
  Scenario: Select paper against rock
    ...
    And I press "play" within "submit"
    Then I should see "And the winner is.." within "result"
    And I should see "You won! paper beats rock" within "result"
  ...
  Scenario: Select paper against scissors
    ...
    And I press "play" within "submit"
    Then I should see "And the winner is.." within "result"
    And I should see "You lose.. scissors beats paper" within "result"
  ...
  Scenario: Select scissors against rock
    ...
    And I press "play" within "submit"
    Then I should see "And the winner is.." within "result"
    And I should see "You lose.. rock beats scissors" within "result"
  ...
  Scenario: Select scissors against paper
    ...
    And I press "play" within "submit"
    Then I should see "And the winner is.." within "result"
    And I should see "You won! scissors beats paper" within "result"
  ...
  Scenario: Select scissors against scissors
    ...
    And I press "play" within "submit"
    Then I should see "And the winner is.." within "result"
    And I should see "You tied with the computer!!" within "result"
    And I should see "You chose scissors and he did the same!!" within "result"
  ...
  Scenario: Select rock against rock
    ...
    Then I should see "And the winner is.." within "result"
    And I should see "You tied with the computer!!" within "result"
    And I should see "You chose rock and he did the same!!" within "result"
  ...
  Scenario: Select paper against paper
    ...
    Then I should see "And the winner is.." within "result"
    And I should see "You tied with the computer!!" within "result"
    And I should see "You chose paper and he did the same!!" within "result"